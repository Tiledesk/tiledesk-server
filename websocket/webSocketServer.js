            ...
            return q.exec(function(err, project) {
              ...
              if (topic.endsWith('/messages')) {
                ...
                .exec(function (err, projectuser) {
                  ...
                  var queryRequest = {id_project:projectId, request_id: recipientId, "draft": { $in: [false, null]} };     
            ...
            .exec(function(err, events) {             
              ...
              //request/id
                  ...
                  .exec(function (err, projectuser) {
                    ...
                    var query = {id_project:projectId, request_id: recipientId, "draft": { $in: [false, null]}};
                  winston.debug('query: '+ JSON.stringify(query));
