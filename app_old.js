...
//deprecated
app.use('/:projectid/aiagents', [passport.authenticate(['basic', 'jwt'], { session: false }), validtoken], aiagents);
...
app.use('/:projectid/permissions', [passport.authenticate(['basic', 'jwt'], { session: false })], permissions);
