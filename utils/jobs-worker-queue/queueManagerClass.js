...
class QueueManager {
    ...
    constructor(url, options) {
        ...
        this.queueName = `${this.exchange}_queue`;
    ...
    processMsg2(msg) {
        ...
        if (that.debug) { console.log("Message received with topic: ", msg.fields.routingKey); }
        const message_string = msg.content.toString();
        if (that.debug) { console.log("end content: ", message_string); }
