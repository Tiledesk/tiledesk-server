...
describe('Authentication', () => {
    ...
    describe('/signin', () => {
            ...
            userService.signup(email, pwd, "Test Firstname", "Test lastname").then(function (savedUser) {
                ...
                chai.request(server)
                    ...
                    .end((err, res) => {
                        ...
                        expect(res.body.token).to.not.have.property('password');
        ...
        // mocha test ./authentication.js  --grep 'signinkO'
        it('signinkO', (done) => {
        ...
        // mocha test ./authentication.js  --grep 'signinValidation'
    ...
    describe('/signup', () => {
        ...
        // mocha test ./authentication.js  --grep 'signupOk'
        it('signupOk', (done) => {
    ...
    describe('/signInAnonymously', () => {
        ...
        // mocha test ./authentication.js  --grep 'signInAnonymouslyOk'
    ...
    describe('/signinWithCustomToken', () => {
        ...
        // mocha test ./authentication.js  --grep 'signinWithCustomTokenOk'
        ...
        // mocha test ./authentication.js  --grep 'signinWithCustomTokenKO'
        ...
        // mocha test ./authentication.js  --grep 'signinWithCustomTokenRoleEmailAlreadyUsed
...
// mocha test ./authentication.js  --grep 'signinWithCustomTokenKONoID
